...
export default function BoardPage() {
  ...
  const { data, isLoading, isError } = useBoardData(
    params.projectKey,
    filters,
  );
  ...
  const handleIssueClick = (issue: Issue) => {
    router.push(`/projects/${params.projectKey}/board?issue=${issue.issueKey}`);
  };
      ...
      <div className="flex items-center gap-2 border-b px-4 py-2">
        ...
        <Button
          ...
          onClick={() =>
            setFilters((prev) => ({
              ...prev,
              assigneeId: prev.assigneeId ? undefined : -1, // -1 = current user
            }))
          }
        >
